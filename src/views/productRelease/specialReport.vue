...
export default {
  ...
  data() {
    return {
      ...
      moversData: [
        ...
        //   serialNum: "1",
        //   storageName: "",
        //   imgUrl: require("@/assets/public/risk.jpg"),
        // },
      ],
      // 未发布------------
  ...
  methods: {
    ...
    getUnpublishedData() {
      ...
      this.$api.statement.specialReport(formData).then((res) => {
        if (res.success == true) {
    ...
    confirmDelete() {
      ...
      this.$api.statement.DeleteSpecialReport(params).then((res) => {
        if (res.success == true) {
          this.$Notice.success({
            title: res.message,
            top: 50,
