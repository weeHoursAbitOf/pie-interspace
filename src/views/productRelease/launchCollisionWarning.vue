        ...
        <div class="publish-module-content">
          <div class="publish-module-message">
            ...
            <div class="publish-module-btn">
              ...
              <!-- <share-btn class="btn-right" title="加入" /> -->
      ...
      <div class="publish-module-content">
        <div class="publish-module-top">
          ...
          <div class="publish-module-btn">
            ...
            <!-- <batch-join-btn class="btn-right"></batch-join-btn> -->
...
export default {
  ...
  data() {
    return {
      ...
      moversData: [
        ...
        //   serialNum: "1",
        //   storageName: "",
        //   imgUrl: require("@/assets/home/collision.svg"),
        // },
      ],
      // 未发布------------
  ...
  methods: {
    ...
    getUnpublishedData() {
      ...
      this.$api.statement.launch(formData).then((res) => {
        if (res.success == true) {
    ...
    confirmDelete() {
      ...
      this.$api.statement.DeleteLaunch(params).then((res) => {
        if (res.success == true) {
          this.$Notice.success({
            title: res.message,
            top: 50,
