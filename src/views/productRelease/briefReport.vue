...
export default {
      ...
      moversData: [
        {
          ...
          serialNum: "1",
          storageName: "",
          imgUrl: require("@/assets/public/briefReport.svg"),
        },
        {
          id: 0,
          path: "1",
      ...
      versionData: [
        {
          id: 0,
          version: "1.0",
          productPath: "工作简报.doc",
          auditor: "kjadmin",
          createTime: "2021-10-12 03:30:03",
          description: "关于工作简报报告！",
          productId: 0,
  ...
  methods: {
    ...
    getUnpublishedData() {
      ...
      this.$api.statement.briefReport(formData).then((res) => {
        if (res.success == true) {
    ...
    confirmDelete() {
      ...
      this.$api.statement.DeleteBriefReport(params).then((res) => {
        if (res.success == true) {
          this.$Notice.success({
            title: res.message,
            top: 50,
