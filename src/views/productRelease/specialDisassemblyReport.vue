...
export default {
  ...
  data() {
    return {
      ...
      moversData: [
        ...
        //   serialNum: "1",
        //   storageName: "",
        //   imgUrl: require("@/assets/public/disassembly.jpg"),
        // },
      ],
      // 未发布------------
  ...
  methods: {
    ...
    getUnpublishedData() {
      ...
      this.$api.statement.breakUp(formData).then((res) => {
        if (res.success == true) {
    ...
    confirmDelete() {
      ...
      this.$api.statement.DeleteBreakUp(params).then((res) => {
        if (res.success == true) {
          this.$Notice.success({
            title: res.message,
            top: 50,
