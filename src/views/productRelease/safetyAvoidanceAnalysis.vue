...
export default {
  ...
  data() {
    return {
      ...
      moversData: [
        ...
        //   serialNum: "1",
        //   storageName: "",
        //   imgUrl: require("@/assets/home/safety.svg"),
        // },
      ],
      // 未发布------------
  ...
  methods: {
    ...
    getUnpublishedData() {
      ...
      this.$api.statement.security(formData).then((res) => {
        if (res.success == true) {
    ...
    confirmDelete() {
      ...
      this.$api.statement.DeleteSecurity(params).then((res) => {
        if (res.success == true) {
          this.$Notice.success({
            title: res.message,
            top: 50,
