...
export default {
    ...
    return {
      list: [
        ...
        },
        {
          ...
          // filterMethod(value, row) {
          //   if (value === 1) {
          //     return row.productType == "TLE";
          //   }
          //   if (value === 2) {
          //     return row.productType == "ELE";
          //   }
          // },
        },
        {
      ...
      productType: "TLE,ELE", //用于请求产品类型（TLE、ELE、SSR、危险交汇、陨落、突发）
      templateType: "1", //templateType:(1)轨道模板TLE,ELE(2)编目(3)危险交汇(4)陨落(5)解体(6)突发
      pageTotal: 10, //数据总数
      pageNum: 1, //初始页
      pageSize: 10, //每页条数
      startTime: "", //开始时间
  ...
  methods: {
    ...
    //     .getTemplatesByTemplateTypes(params)
    //     .then((res) => {
    //       if (res.success == true) {
