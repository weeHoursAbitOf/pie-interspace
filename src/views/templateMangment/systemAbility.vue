<template>
  <div>
    <template-details v-if="isShowTemplate" :dataList="dataList" />
    <div class="pie-tb-content" v-if="!isShowTemplate">
      <pie-card>
...
<script>
import templateDetails from "@/components/templateMangment/templateDetails.vue";
      ...
      dataList: [
        {
          ...
          name: "系统能力",
          productId: 15,
          createTime: "2021-01-01 10:30:00",
          description: "关于系统能力模板一的介绍",
